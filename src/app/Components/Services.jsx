  ...
  return (
    <div className="py-20 overflow-hidden">
      <div className="w-[96%] md:w-[90%] mx-auto">
        <div className="title text-3xl text-center py-10 uppercase">
          Our Best Services
        </div>
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-5">
          <div className="flex items-center gap-2 ">
            ...
            <p className=""> 100% secure online payments </p>
          </div>
          <div className="flex items-center gap-2 ">
            <div className="p-3 bg-violet-500 rounded-full">
              {/* <svg
            ...
            <p className=""> 30 days exchanger & return period </p>
          </div>
          <div className="flex items-center gap-2 ">
            <div className="p-3 bg-violet-500 text-white rounded-full">
              {/* <svg
            ...
            <p className=""> Free shipping for orders over $150 </p>
          </div>
        </div>
      </div>
    </div>
